...
class ParkingLot {
  ...
  async park(vals) {
    ...
    //   }
    // }
    return await axios.post(`http://49.145.117.33:3000/park`, vals)
    .then(({data}) => {
      console.log(data)
        return data
    })
  ...
  remove(_id) {
    ...
    return axios.get(`http://49.145.117.33:3000/unpark/${_id}`)
    .then(({data}) => {
        return data
    })
    .catch(err => {
  ...
  update(_id, data) {
    ...
    return axios.put(`http://49.145.117.33:3000/slot/${_id}`, data)
    .then(({data}) => {
        return data
    })
    .catch(err => {
...
//W/ 24 hours chunk. 
  ...
  getAllSlots (id){
    return axios.get(`http://49.145.117.33:3000/slots/${id}`)
    .then(({data}) => {
        this.slots = data;
        return data
    })
